...
[![Tests](https://github.com/spatie/laravel-validation-rules/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/laravel-validation-rules/actions/workflows/run-tests.yml)
